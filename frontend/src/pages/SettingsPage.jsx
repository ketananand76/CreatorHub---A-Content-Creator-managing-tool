...
import { User, Shield, Info, Youtube, Instagram, Facebook, Save, ShieldCheck, Camera } from 'lucide-react';
          ...
          <div className="md:col-span-2 glass p-6 rounded-2xl border space-y-6">
            ...
            <div>
              ...
              <div className="flex items-center gap-4 mb-4">
                <div className="relative w-16 h-16 rounded-full overflow-hidden bg-slate-100 dark:bg-slate-800 flex items-center justify-center border-2 border-brand-500/30 shrink-0 group">
                  {profilePicture ? (
                ...
                <div className="text-xs text-slate-500 dark:text-slate-400">
                  <p className="font-medium text-slate-700 dark:text-slate-300">Upload new avatar</p>
