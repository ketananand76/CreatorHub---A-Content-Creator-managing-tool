            ...
            >
              ...
              <div className="space-y-4">
                <div className="bg-brand-500/5 p-4 rounded-xl border dark:border-slate-800 space-y-3 text-center">
                  ...
                  <a
                    href={`upi://pay?pa=9771735011@mbk&am=999.00&cu=INR`}
                ...
                <div className="text-center py-4 bg-slate-50 dark:bg-slate-900 rounded-xl border border-dashed dark:border-slate-800">
                  ...
                  <div className="w-32 h-32 bg-white flex items-center justify-center mx-auto my-3 rounded-lg p-1">
                    <img 
                      src={`https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=${encodeURIComponent('upi://pay?pa=9771735011@mbk&am=999.00&cu=INR')}`} 
                      alt="UPI QR Code"
